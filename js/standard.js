...
function shipping_costs(){
	window.open("/content/shippingcosts/?blank=true","Shipping","height=580,width=710,menubar=no,location=no,resizable=false,scrollbars=yes,status=yes,toolbar=no,top=0");
}
